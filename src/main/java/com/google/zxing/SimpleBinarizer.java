...
public abstract class SimpleBinarizer {
	   ...
	   */
	  public abstract BitVectorMatrix getBlackMatrix() throws NotFoundException;
	   ...
	   */
	  public abstract SimpleBinarizer createBinarizer(LuminanceSource source);
