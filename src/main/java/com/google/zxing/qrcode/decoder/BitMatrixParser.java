      ...
      for (int count = 0; count < dimension; count++) {
        ...
        for (int col = 0; col < 2; col++) {
          ...
          if (!functionPattern.get(j - col, i)) {
            ...
            bitsRead++;
            currentByte <<= 1;
            //System.out.println("After shift-currentByte="+currentByte);
            if (bitMatrix.get(j - col, i)) {
              currentByte |= 1;
              //System.out.println("currentByte(OR)="+currentByte);
            }
            //System.out.println("bool="+bitMatrix.get(j-col, i)+" position = "+(j-col)+","+i);
